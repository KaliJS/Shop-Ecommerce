...
<div id="tt-pageContent">
	...
	<div class="container-indent">
		<div class="container container-fluid-lg">
			<ul class="nav nav-tabs tt-tabs-default" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" data-ajax-include="ajax-content/index21_tabs_mens.html" data-toggle="tab" href="#tt-tab01-02">MENS</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-ajax-include="ajax-content/index21_tabs_shoes.html" data-toggle="tab" href="#tt-tab01-03">SHOES</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-ajax-include="ajax-content/index21_tabs_accessories.html" data-toggle="tab" href="#tt-tab01-04">ACCESSORIES</a>
				</li>
			</ul>
	...
	<div class="container-indent">
		<div class="container container-fluid-lg">
			<div class="row tt-layout-col">
				<div class="col-md-6">
					<div class="tt-promo-video">
						<div class="tt-promo-video__link">
							<video src="video/txtandvideo_01.mp4" poster="images/promo/index21-promo-img-01.jpg" preload="auto" autoplay="autoplay" loop></video>
						</div>
						<div class="tt-description tt-point-h-l tt-point-v-t text-left">
							<h2 class="tt-title">Video block</h2>
				...
				<div class="col-md-6">
					<div class="tt-productone row">
						<div class="tt-image-box col-6">
							<img src="images/loader.svg" data-src="images/product/product-15.jpg" alt="">
						</div>
						<div class="tt-description col-6">
							<ul class="tt-add-info">
							...
							<div class="tt-row-btn">
								<a href="#" class="btn" data-toggle="modal" data-target="#modalAddToCartProduct">ADD TO CART</a>
							</div>
							<div class="tt-row-btn">
								<a href="#" class="tt-productone__btn-icon">
									<i class="icon-n-072" data-tooltip="You need to login" data-tposition="left"></i>
								</a>
								<a href="#" class="tt-productone__btn-icon">
									<i class="icon-n-08" data-tooltip="Add to Compare" data-tposition="left"></i>
								</a>
							</div>
						</div>
					</div>
	...
	<div class="container-indent">
		<div class="container container-fluid-lg">
			<div class="row tt-promo-vide__revers">
				<div class="col-md-6">
					<div class="tt-promo-video">
						<div class="tt-promo-video__link">
							<video src="video/video_small.mp4" poster="images/promo/index21-promo-img-02.jpg"  preload="auto" autoplay="autoplay" loop>></video>
						</div>
						<div class="tt-description tt-point-h-l tt-point-v-t text-left">
							<h2 class="tt-title">Video block</h2>
							Great variety of available options will make customization process very easy.
						</div>
					</div>
				</div>
				<div class="divider d-block d-md-none"></div>
				<div class="col-md-6">
					<div class="tt-productone row">
						<div class="tt-image-box col-6">
							<img src="images/loader.svg" data-src="images/product/product-24.jpg" alt="">
						</div>
						<div class="tt-description col-6">
							<ul class="tt-add-info">
								<li><a href="#">CATEGORY</a></li>
			...
			<div class="row tt-layout-promo-box">
				<div class="col-6 col-md-3 col-12-575width">
					<a href="listing-left-column.html" class="tt-promo-box tt-one-child">
						<img src="images/loader.svg" data-src="images/promo/index06-promo-img-06.jpg" alt="">
						<div class="tt-description">
							<div class="tt-description-wrapper">
								<div class="tt-background"></div>
				...
				<div class="col-6 col-md-3 col-12-575width">
					<a href="listing-left-column.html" class="tt-promo-box tt-one-child">
						<img src="images/loader.svg" data-src="images/promo/index06-promo-img-05.jpg" alt="">
						<div class="tt-description">
							<div class="tt-description-wrapper">
								<div class="tt-background"></div>
				...
				<div class="col-6 col-md-3 col-12-575width">
					<a href="listing-left-column.html" class="tt-promo-box tt-one-child">
						<img src="images/loader.svg" data-src="images/promo/index06-promo-img-11.jpg" alt="">
						<div class="tt-description">
							<div class="tt-description-wrapper">
								<div class="tt-background"></div>
				...
				<div class="col-6 col-md-3 col-12-575width">
					<a href="listing-left-column.html" class="tt-promo-box tt-one-child">
						<img src="images/loader.svg" data-src="images/promo/index06-promo-img-09.jpg" alt="">
						<div class="tt-description">
							<div class="tt-description-wrapper">
								<div class="tt-background"></div>
				...
				<div class="col-6 col-md-3 col-12-575width">
					<a href="listing-left-column.html" class="tt-promo-box tt-one-child">
						<img src="images/loader.svg" data-src="images/promo/index06-promo-img-08.jpg" alt="">
						<div class="tt-description">
							<div class="tt-description-wrapper">
								<div class="tt-background"></div>
				...
				<div class="col-6 col-md-3 col-12-575width">
					<a href="listing-left-column.html" class="tt-promo-box tt-one-child">
						<img src="images/loader.svg" data-src="images/promo/index06-promo-img-10.jpg" alt="">
						<div class="tt-description">
							<div class="tt-description-wrapper">
								<div class="tt-background"></div>
				...
				<div class="col-6 col-md-3 col-12-575width">
					<a href="listing-left-column.html" class="tt-promo-box tt-one-child">
						<img src="images/loader.svg" data-src="images/promo/index06-promo-img-12.jpg" alt="">
						<div class="tt-description">
							<div class="tt-description-wrapper">
								<div class="tt-background"></div>
				...
				<div class="col-6 col-md-3 col-12-575width">
					<a href="listing-left-column.html" class="tt-promo-box tt-one-child">
						<img src="images/loader.svg" data-src="images/promo/index06-promo-img-07.jpg" alt="">
						<div class="tt-description">
							<div class="tt-description-wrapper">
								<div class="tt-background"></div>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-10 col-lg-8 col-xl-6">
					<div class="tt-layout-newsletter03">
						<h5 class="tt-title">KEEP IN TOUCH</h5>
						<div class="tt-title-description">Enjoy 15% off your first order when you join our mailing list.</div>
						<form id="newsletterform02" class="form-inline form-default" method="post" novalidate="novalidate" action="#">
