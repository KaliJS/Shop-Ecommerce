    ...
    <form class="form-horizontal" action="{{route('users.store')}}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" value="{{Request::old('first_name')}}" name="first_name" placeholder="First Name">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" value="{{Request::old('last_name')}}" name="last_name" placeholder="Last Name">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="number" value="{{Request::old('pincode')}}" name="pincode" placeholder="Pincode">
            </div>
        </div>
